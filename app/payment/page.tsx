    ...
    <main style={{ minHeight: "100vh", background: "linear-gradient(135deg, #c2410c 0%, #ea580c 50%, #d97706 100%)", backgroundImage: "url('https://images.unsplash.com/photo-1719399184315-5ffab4006e18?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fCVFQyVCQiVBOCVFQyU4NSU4OSUyMCVFQyU5NSU4NCVFRCU4QSVCOHxlbnwwfHwwfHx8MA%3D%3D')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", color: "white", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, padding: "40px 16px" }}>
        ...
        <section style={{ maxWidth: 800, margin: "0 auto 60px", textAlign: "center" }}>
          ...
          <p style={{ color: "#1a1a1a", fontSize: 14, fontWeight: 900, marginBottom: 12, lineHeight: 1.8 }}>음양오행·천간지지 십성 완벽 분석</p>
          <p style={{ color: "#1a1a1a", fontSize: 15, fontWeight: 900, marginBottom: 24 }}>최고 수준의 사주 분석</p>
          <p style={{ color: "#fbbf24", fontSize: 14, fontWeight: 700, marginBottom: 32, lineHeight: 1.8 }}>당신의 인생을 완벽하게 읽어드립니다</p>
          <p style={{ color: "#1a1a1a", fontSize: 15, fontWeight: 900, marginBottom: 24, lineHeight: 1.8 }}>50페이지 기본분석부터 150페이지 완벽분석까지<br/>당신의 성격, 재물운, 연애운, 건강운, 직업 추천, 올해 운세까지 모두 포함!</p>
        </section>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto", marginBottom: 40, background: "#f5f5f5", padding: 24, borderRadius: 12 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <h4 style={{ color: "#1a1a1a", fontSize: 13, fontWeight: 900, marginBottom: 12 }}>첫 번째 (4개)</h4>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
              {fortuneItems.slice(0, 4).map(item => (
                <div key={item.id} style={{ background: selectedFeatures.includes(item.id) ? "#fbbf24" : "#e0e0e0", border: selectedFeatures.includes(item.id) ? "2px solid #f59e0b" : "1px solid #cccccc", borderRadius: 10, padding: 12, textAlign: "center" }}>
                  ...
                  <p style={{ color: "#1a1a1a", fontSize: 11, fontWeight: 900, margin: 0 }}>{item.name}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <h4 style={{ color: "#1a1a1a", fontSize: 13, fontWeight: 900, marginBottom: 12 }}>두 번째 (4개)</h4>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
        ...
        <section style={{ maxWidth: 900, margin: "0 auto 60px", background: "rgba(139,92,246,0.2)", padding: 40, borderRadius: 12 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 24 }}>
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#1a1a1a", fontSize: 13, fontWeight: 900 }}>기본분석(30P)부터 VIP 커플팩(150P)까지</p>
            </div>

            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 32, marginBottom: 12 }}>💰</div>
              <h3 style={{ color: "#fbbf24", fontWeight: 900, marginBottom: 8 }}>합리적인 가격</h3>
              <p style={{ color: "#1a1a1a", fontSize: 13, fontWeight: 900 }}>9,900~29,900</p>
            </div>

            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 32, marginBottom: 12 }}>⚡</div>
              <h3 style={{ color: "#fbbf24", fontWeight: 900, marginBottom: 8 }}>즉시 다운로드</h3>
              <p style={{ color: "#1a1a1a", fontSize: 13, fontWeight: 900 }}>3분 이내 PDF 완성</p>
            </div>
          </div>
        </section>
        ...
        <div style={{ maxWidth: 500, margin: "0 auto", textAlign: "center" }}>
          <p style={{ color: "#1a1a1a", fontSize: 14, fontWeight: 900, marginBottom: 10 }}>
            선택된 패키지: <span style={{ color: "#1a1a1a", fontWeight: 900 }}>{selectedPackage}</span>
          </p>
          <p style={{ color: "#1a1a1a", fontSize: 13, fontWeight: 900, marginBottom: 20 }}>
            📄 {currentPages}페이지
          </p>
